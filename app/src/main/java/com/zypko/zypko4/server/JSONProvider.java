...
public class JSONProvider{
    ...
    public void getJson(String url, final HTTP_Get calback){
        ...
        request.setTag(com.zypko.zypko4.server.NetRequest.TAG);
        com.zypko.zypko4.server.NetRequest.getInstance(context).addToRequestQueue(request);
    }
